#ifndef __SKL_ACCESS_GB_UART_H__
#define __SKL_ACCESS_GB_UART_H__
...
{ \
    ...
    pstModMsg->usLen = SklAccess_String2Short(pcData + GB_UART_INDEX_LEN); \
...
extern void GB_uart_modulePacketProcess(SKL_QUEUE_MSG_s *pstMsg);

#endif //__SKL_ACCESS_GB_UART_H__
