#ifndef __SKL_ACCESS_COMMON_H__
#define __SKL_ACCESS_COMMON_H__

#define SKL_ACCESS_BCD2DIGIT(a) ((((a) & 0xF0) >> 4) * 10 + ((a) & 0x0F))

#define SKL_VEHICLE_GB_UART         "/dev/ttyS1"

typedef enum _SKL_CMD_e_
{
    /* 采集命令集 */
...
extern ULONG SklAccess_init(void);
extern void SklAccess_destory(void);
extern BOOL SklAccess_String2Bcd(IN CHAR *str, OUT UCHAR *BCD, OUT INT *BCD_length);
extern BOOL SklAccess_Bcd2String(IN UCHAR *BCD, IN INT BCD_length, OUT CHAR *str);
extern ULONG SklAccess_Bcd2ULONG(IN ULONG m);
extern ULONG SklAccess_ULONG2Bcd(IN ULONG m);
extern USHORT SklAccess_String2Short(UINT8 *pData);

#endif //__SKL_ACCESS_COMMON_H__
